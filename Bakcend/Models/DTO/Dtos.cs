...
namespace Bakcend.Models.DTO
{
    ...
    public record UpdatePurchaseDto(string BillingName, string BillingPostalCode, string BillingAddress, string Email, string PostalCode, string DeliveryAddress, string PhoneNumber, string UserId);
